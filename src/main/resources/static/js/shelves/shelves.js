...
{
    var data = {};
    data.shelvesId = $('#shevel').val().trim();
    // alert($('#isEmpty').val());
    ...
    $('#data_table').load("/a/shelvesList/condition" , {'params':dataJson});
    setTableCss();
}
...
/*
    跳转货架详情
 */
function goShelvesDetailed(shelvesId) {
    window.location.href = '/a/shelves/shelvesDetail/' + shelvesId + '/';
}